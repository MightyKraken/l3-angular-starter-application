...
export class ScrollAwayToolbarDirective {
	...
	constructor() {
		// Wait until attrs like data-toolbar-behavior are bound; always attach
		// scroll listener — behavior is checked on each scroll (supports switching
		// fixed ↔ scroll-away without remounting).
		afterNextRender(
			() => {
				this.setup();
			},
